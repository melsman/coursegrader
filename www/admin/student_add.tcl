...
set selection [ns_db 0or1row $db "select person_id from vu_person
                                  where email = '$QQemail'"]
if { $selection == "" } {
    # nope; the function call below redirects us to student_add2.tcl 
    # after requesting a person name from the user 
    vu_person_add $email "student_add2.tcl?course_id=$course_id&"
    return
}

set_variables_after_query

ns_returnredirect "student_add2.tcl?course_id=$course_id&person_id=$person_id"
